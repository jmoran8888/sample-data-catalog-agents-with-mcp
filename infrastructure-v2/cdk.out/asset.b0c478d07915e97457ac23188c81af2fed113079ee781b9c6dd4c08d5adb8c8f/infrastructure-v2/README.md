...
Use the deployment wrapper script (similar to Terraform's `deploy_aws.py`):

```bash
python setup/deploy_cdk.py
```

This script automatically:
- ✅ Checks prerequisites (Node.js, Docker, AWS CLI)
- ✅ Installs dependencies
- ✅ Forces deployment to us-east-1
- ✅ Builds and deploys all stacks
